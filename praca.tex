...
\DeclareUnicodeCharacter{2208}{$\mathrm{\in}$}
\DeclareUnicodeCharacter{2264}{$\mathrm{\le}$}
\DeclareUnicodeCharacter{22C2}{$\mathrm{\cap}$}
\DeclareUnicodeCharacter{2298}{$\mathrm{\emptyset}$}
...
% Rozdziały dołączone z zewnątrz
\input{wstep}
\input{rozdzial1}
\input{rozdzial2}
\input{rozdzial3}
